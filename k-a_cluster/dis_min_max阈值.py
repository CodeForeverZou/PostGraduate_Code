...
def save2file():
    path = os.path.abspath('..')  # 表示当前所处的文件夹上一级文件夹
    data_path = path + '\\k-a_cluster\\result100-1.txt'
    #data_path = path + '\\k-a_cluster\\result5000-1.txt'
    #data_path = path + '\\k-a_cluster\\result10000-1.txt'
